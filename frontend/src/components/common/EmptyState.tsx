...
export const EmptyState: React.FC<EmptyStateProps> = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 text-center rounded-xl bg-white border border-[#DDE5E3] my-2 shadow-[0_2px_6px_rgba(23,33,33,0.02)]">
      ...
      <h3 className="text-xs sm:text-sm font-bold text-[#172121] mb-1">{title}</h3>
