...
export const CitizenOcrPage: React.FC = () => {
  ...
  const handleStartOcr = (e: React.FormEvent) => {
    ...
    // Simulate OCR processing steps and show backend requirement notice
    setTimeout(() => {
      setStep('result');
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs space-y-6">
          <div className="flex items-center justify-between border-b border-slate-200 pb-4">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">Field-by-field verification structure preview.</p>
            </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs">
              ...
              <tbody className="divide-y divide-slate-200 text-slate-800">
                <tr>
                  <td className="p-3 font-semibold text-slate-900">Survey Number</td>
                  <td className="p-3 font-mono">Backend Value</td>
                  <td className="p-3 font-mono">Document Value</td>
                  <td className="p-3">
                ...
                <tr>
                  <td className="p-3 font-semibold text-slate-900">Property Extent</td>
                  <td className="p-3 font-mono">Backend Value</td>
                  <td className="p-3 font-mono">Document Value</td>
                  <td className="p-3">
                ...
                <tr>
                  <td className="p-3 font-semibold text-slate-900">Patta Number</td>
                  <td className="p-3 font-mono">Backend Value</td>
                  <td className="p-3 font-mono">Document Value</td>
                  <td className="p-3">
